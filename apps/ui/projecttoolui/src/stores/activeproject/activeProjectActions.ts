 ...
 * @param project
 */
export function actionUpdateActiveProject(project: IProject, saveImmediately?: boolean): void {
    if (!activeProjectStore.project) {
 ...
 * @param target
 */
export function actionUpdateProjectTechStack(
    techs: ITechnology[],
