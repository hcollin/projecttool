...
import { actionRemovePhaseFromActiveProject, actionUpdateProjectPhaseInActiveProject } from "../../../stores/activeproject/activeProjectActions";
		...
		<Card mb="md">
			...
			<Flex gap="lg" align="center" justify="space-between">
				...
				<Flex align="center">
					...
					{phase.end.lengthInWorkingDays !== undefined && <Text>Duration: {phase.end.lengthInWorkingDays} working days</Text>}
				</Flex>
