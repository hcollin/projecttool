...
import { AppShell, Center, Container, Divider, NavLink, Title } from "@mantine/core";
...
const DataShell = (props: { children: React.ReactNode; noContainer?: boolean }) => {
	...
	return (
		...
		>
			...
			<AppShell.Navbar className="project-navbar">
				...
				<Divider label="Texts" labelPosition="center" my="sm" />
				<NavLink label="All Texts" component={Link} to="/data/texts/" />
			</AppShell.Navbar>

			<AppShell.Main className="main-content">{props.noContainer ? props.children : <Container size="xl">{props.children}</Container>}</AppShell.Main>
