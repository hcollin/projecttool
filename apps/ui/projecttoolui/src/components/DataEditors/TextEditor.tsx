...
import { Box, Button, Card, Flex, Group, Input, Stack, TagsInput, TextInput } from "@mantine/core";
                ...
                <Stack gap="md">
                    <Flex justify="space-between" align="flex-start">
                        ...
                        <Input.Wrapper
                            ...
                            flex="1 1 auto"
                            ml="md"
                            description="The language code of the text (e.g., 'en' for English)."
                        >
                            <Group gap="xs" style={{ marginTop: "calc(var(--mantine-spacing-xs) / 2)" }}>
                                {VALIDLANGUAGES.map(([code, label]) => (
                                    <Button
                                        variant={language === code ? "filled" : "default"}
                                        size="sm"
