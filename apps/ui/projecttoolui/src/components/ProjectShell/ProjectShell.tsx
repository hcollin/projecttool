...
import { actionCreateNewProject, actionSaveActiveProject } from "../../stores/activeproject/activeProjectActions";
    ...
    return (
        ...
        >
            ...
            <AppShell.Navbar className="project-navbar">
                ...
                <Divider label={aps.project ? aps.project.name : "No Active Project"} labelPosition="center" my="sm" />
