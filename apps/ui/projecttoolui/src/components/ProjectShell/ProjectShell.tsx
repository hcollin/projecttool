...
import { actionCreateEmptyProject } from "../../stores/generalActions";
        ...
        >
            ...
            <AppShell.Navbar className="project-navbar no-print" >
                ...
                <NavLink
                    ...
                    component={Link}
                    to="/project/summarytable"
                    disabled={!aps.project}
                    leftSection={<IconTable />}
                />
                <NavLink
                    label="Project Charts"
                    component={Link}
                    to="/project/projectcharts"
                    disabled={!aps.project}
