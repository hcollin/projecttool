...
import { EDOCLANG, EDOCTYPE, IDocFile, IProject } from "@frosttroll/projecttoolmodels";
        ...
        <>
            <ProjectCard>
                <Flex align="center">
                    ...
                    <Text>
                        {DateTime.fromMillis(doc.createdAt).setLocale("fi").toLocaleString(DateTime.DATETIME_SHORT)}
                    </Text>
                    <Flex justify="flex-end" style={{ flex: "1 1 auto" }}>
                        <Button
                            variant="contained"
                            leftSection={<IconAutomation />}
