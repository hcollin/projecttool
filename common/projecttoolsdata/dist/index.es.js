var e = /* @__PURE__ */ ((s) => (s.INTERN = "Intern", s.JUNIOR = "Junior", s.MIDLEVEL = "Mid-level", s.SENIOR = "Senior", s.LEAD = "Lead", s.PRINCIPAL = "Principal", s))(e || {});
const i = [
  // Management
  {
  ...
  },
  {
    ...
    groups: ["Architecture"],
    seniorities: [e.LEAD, e.PRINCIPAL],
