 ...
 * @param project
 */
export function utilCalculatePhaseDuration(phase, project, inWorkDays) {
    let start = utilGetPhaseStartTs(phase, project);
    let end = utilGetPhaseEndTs(phase, project);
    if (end > start) {
        if (inWorkDays) {
...
export function utilGetPhaseStartTs(phase, project) {
    let start = 0;
...
export function utilGetPhaseEndTs(phase, project) {
    let end = 0;
    if (phase.end.ts) {
 ...
 * @returns
 */
export function utilCalculatePhasePrice(phase, project) {
 ...
 * @returns
 */
export function utilCalculatePhaseSingleDay(phase, project) {
    const response = {
        hours: 0,
        price: 0,
        currency: "",
